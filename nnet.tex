...
% 44 - todo
\input{bms/bezdratove_lokalni_site/text}
\newpage

% 45
\input{gal/hledani_minimalni_kostry/text}
\newpage

% 46
\input{gal/hledani_nejkratsich_cest/text}
\newpage

% 47
\input{pdi/volba_koordinatora/text}
\newpage

% 48
\input{pdi/konzistentni_globalni_stav/text}
\newpage

% 49
\input{pdi/map_reduce/text}
\newpage

% 50
\input{kry/symetricka_kryptografie/text}
\newpage

% 51
\input{kry/asymetricka_kryptografie/text}
\newpage

% 52
\input{kry/hasovaci_funkce/text}
\newpage

% 53
\input{kry/sprava_klicu_v_asymetricke/text}
\newpage

% 54
\input{pds/prepinace/text}
\newpage

% 55
\input{pds/smerovace/text}
\newpage

% 56 - todo
\input{pds/teorie_smerovani/text}
\newpage

% 57
\input{pds/rizeni_toku_a_prevence_zahlceni/text}
\newpage
