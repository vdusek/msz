...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{49/map_reduce_example.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{49/map_reduce_general_p1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{49/map_reduce_general_p2.png}
    \caption{Výpočet MapReduce v obecném schématu a rozdělením práce na jednotlivé uzly (uzel je typicky víceprocesorový).}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{49/map_reduce_detail.png}
...
\paragraph*{Čtení dat} Pro čtení dat se klient zeptá Name Nodu na konkrétní soubor v HDFS. Name Node vrátí metadata o souboru, na jakých Data Nodech se vyskytuje. Klient požádá příslušné Data Nody, ty mu pošlou data, která se na klientovi \uv{poskládají} do výsledného souboru.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{49/spark.png}
