...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{architektura_se_sdilenym_procesorem.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{architektura_se_sdilenym_procesorem_a_pameti_cache_na_karte.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{architektura_s_nezavislymi_moduly_fe.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{architektura_s_nezavislymi_moduly_fe_a_prepinanou_sbernici.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{architektura_distribuovana.pdf}
