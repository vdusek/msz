...
\subsection*{Sestrojení MAC pomocí CBC}
...
% todo
% pokial funkcia $h_k$ je MAC, potom $h_k$ vzhladok k utoku so zvolenym textom (chosen-text attack) je: 2nd preimage a collision resistant, 1st preimage resistant.

Proč stačí výrazně menší délka? Protože klíč.
% pokracovat v zaznamu 1:38:30
